...
def testing_frameworks
  pod "Nimble", git: "https://github.com/Quick/Nimble.git", tag: "v8.0.4", inhibit_warnings: true
  pod "Quick", git: "https://github.com/Quick/Quick.git", tag: "v2.2.0", inhibit_warnings: true
end
